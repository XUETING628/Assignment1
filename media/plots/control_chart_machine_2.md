...
control_chart_plot <- plot_ly(x = ~plot_index, y = ~valid_part_length, type = 'scatter', mode = 'lines+markers', name = 'PartLength') %>% 
  ...
  layout(title = list(text = "Control Chart for PartLength (Machine 2 at 338K, 200kPa)", font = list(size = 18)),
...
htmlwidgets::saveWidget(control_chart_plot, file = "media/plots/control_chart_machine_2.html", selfcontained = TRUE)
