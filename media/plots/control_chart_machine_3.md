...
control_chart_plot <- plot_ly(x = ~plot_index, y = ~valid_part_length, type = 'scatter', mode = 'lines+markers', name = 'PartLength') %>% 
  ...
  layout(title = list(text = "Control Chart for PartLength (Machine 3 at 338K, 200kPa)", font = list(size = 18)),
...
htmlwidgets::saveWidget(control_chart_plot, file = "media/plots/control_chart_machine_3.html", selfcontained = TRUE)
