...
capability_plot <- plot_ly(x = ~valid_part_length, type = 'histogram', histnorm = 'density', name = 'Distribution', marker = list(color = '#0072B2')) %>% 
  ...
  layout(title = list(text = "Process Capability Chart for PartLength (Machine 1,2,3 at 338K, 200kPa)", font = list(size = 18)),
...
htmlwidgets::saveWidget(capability_plot, file = "media/plots/capability_chart_machine_123.html", selfcontained = TRUE)
